...
apple = cv2.imread('hello/Resources/apple.jpg')
orange = cv2.imread('hello/Resources/orange.jpg')


orange = cv2.resize(orange, (600, 600), interpolation = cv2.INTER_AREA)
apple = cv2.resize(apple, (600, 600), interpolation = cv2.INTER_AREA)

#apple_orange = np.hstack((orange[:, :330], apple[:, 350:]))
